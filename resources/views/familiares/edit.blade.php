@extends('layouts.app')
@php
    dump('CATA_tipo_sangre: ' . $familiare->CATA_tipo_sangre);
    dump('CATA_Estado: ' . $familiare->CATA_Estado);
    dump($tipos_sangre->toArray());
    dump($estados->toArray());
@endphp
@section('header')
            ...
            <form action="{{ route('familiares.update', $familiare->id) }}" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="nombre" id="nombre"
                        ...
                        value="{{ $familiare->nombre }}" disabled>
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="apellido" id="apellido"
                        class="border rounded w-full py-2 px-3 bg-gray-100 cursor-not-allowed"
                        value="{{ $familiare->apellido }}" disabled>
                ...
                <div class="mb-4">
                    ...
                    <input type="date" name="fecha_nacimiento" id="fecha_nacimiento"
                        class="border rounded w-full py-2 px-3 bg-gray-100 cursor-not-allowed"
                        value="{{ $familiare->fecha_nacimiento }}" disabled>
                    ...
                    <select name="CATA_tipo_sangre" id="CATA_tipo_sangre" class="border rounded w-full py-2 px-3">
                        ...
                        @foreach ($tipos_sangre as $tipo)
                            <option value="{{ $tipo->Codigo }}"
                                {{ old('CATA_tipo_sangre', $familiare->CATA_tipo_sangre) == $tipo->Codigo ? 'selected' : '' }}>
                                {{ $tipo->Valor1 }}
                            </option>
                        @endforeach
                    </select>
                ...
                <div class="mb-4">
                    ...
                    <input type="email" name="correo" id="correo" class="border rounded w-full py-2 px-3"
                        value="{{ old('correo', $familiare->correo) }}" required>
                    @error('correo')
                        <p class="text-red-500">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="telefono" id="telefono" class="border rounded w-full py-2 px-3"
                        value="{{ old('telefono', $familiare->telefono) }}" required>
                    @error('telefono')
                        <p class="text-red-500">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="contacto_nombre1" id="contacto_nombre1"
                        ...
                        value="{{ old('contacto_nombre1', $familiare->contacto_nombre1) }}">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="contacto_telefono1" id="contacto_telefono1"
                        class="border rounded w-full py-2 px-3"
                        value="{{ old('contacto_telefono1', $familiare->contacto_telefono1) }}">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="contacto_nombre2" id="contacto_nombre2"
                        class="border rounded w-full py-2 px-3"
                        value="{{ old('contacto_nombre2', $familiare->contacto_nombre2) }}">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="contacto_telefono2" id="contacto_telefono2"
                        class="border rounded w-full py-2 px-3"
                        value="{{ old('contacto_telefono2', $familiare->contacto_telefono2) }}">
                    ...
                    <select name="CATA_Estado" id="CATA_Estado" class="border rounded w-full py-2 px-3" required>
                        ...
                        @foreach ($estados as $estado)
                            <option value="{{ $estado->Codigo }}"
                                {{ old('CATA_Estado', $familiare->CATA_Estado) == $estado->Codigo ? 'selected' : '' }}>
                                {{ $estado->Valor1 }}
                            </option>
                        @endforeach
                    </select>
